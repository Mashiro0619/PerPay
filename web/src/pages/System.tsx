      ...
      {checking &&
        (unavailable ? (
          <div className="flex flex-col gap-4">
            <Alert>
              <CircleAlert />
              <AlertTitle>暂时无法确认运行状态</AlertTitle>
            </Alert>
            <ErrorNotice
              error={status.error}
                    ...
                    <ItemGroup>
                      ...
                      >
                        ...
                        {data.reconciliation.last_error_code && (
                          <p>
                            ...
                            连续失败 {data.reconciliation.consecutive_failures}{" "}
                            次
                          </p>
                        )}
                      </ComponentStatus>
                      <ComponentStatus
                        ...
                        summary={
                          data.webhook.enabled
                            ? "最近成功 " +
                              dateTime(data.webhook.last_success_at)
                            : "已关闭，业务网站需主动查单"
                        }
                        metrics={
                          <>
                      ...
                      >
                        ...
                        {!data.backup.backup_available &&
                          data.backup.enabled && <p>暂无可用备份。</p>}
                      </ComponentStatus>
                    </ItemGroup>
                  </CardContent>
                </Card>
